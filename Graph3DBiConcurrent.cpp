...
namespace gracfl {
    ...
    static ull countEdgeHelperConcurrent(tbb::concurrent_vector<tbb::concurrent_vector<tbb::concurrent_unordered_set<ull>>>& hashset)
    {
        ull size = 0;
    ...
    {
        outEdges_.assign(getNodeSize(), tbb::concurrent_vector<TemporalVectorConcurrent>(getLabelSize()));
        inEdges_.assign(getNodeSize(), tbb::concurrent_vector<TemporalVectorConcurrent>(getLabelSize()));
        hashset_.assign(getNodeSize(), tbb::concurrent_vector<tbb::concurrent_unordered_set<ull>>(getLabelSize(), tbb::concurrent_unordered_set<ull>()));
    }
