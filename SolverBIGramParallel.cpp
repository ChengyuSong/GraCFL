...
namespace gracfl 
{
    ...
    static std::vector<std::vector<std::unordered_set<ull>>> to_std_hashset(
        const tbb::concurrent_vector<tbb::concurrent_vector<tbb::concurrent_unordered_set<ull>>>& 
        tbb_hashset)
    {
    ...
    void SolverBIGramParallel::runSingleIterationParallel(
        tbb::concurrent_vector<tbb::concurrent_vector<TemporalVectorConcurrent>>& outEdges,
        tbb::concurrent_vector<tbb::concurrent_vector<TemporalVectorConcurrent>>& inEdges,
        tbb::concurrent_vector<tbb::concurrent_vector<tbb::concurrent_unordered_set<ull>>>& hashset,
